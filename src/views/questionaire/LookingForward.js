        ...
        <Layout navigation={navigation}>
            ...
            <View style={{height:"100%"}}>
                <View style={{justifyContent:"center",flex:1,alignContent:"center",}}>
                    <Text style={[styles.questionaireQuestion]}>{t('questions:questions.three.title')}</Text>
                    <Text style={[styles.font,{fontSize:13,color:Colors.grey600,textAlign:"center"}]}>{t('questions:questions.three.subtitle')}</Text>
                </View>
                <FAB 
